...
class PlatformResponsive {
  ...
  static double w(double width) {
    if (kIsWeb) {
      // For web, use a simple scaling factor based on viewport
      return width * (screenWidth / _designWidth);
    }
    try {
      return width.w;
    } catch (e) {
      return width; // Fallback to original value
    }
  }
  ...
  static double h(double height) {
    ...
    try {
      ...
      return height; // Fallback to original value
    }
  }
  ...
  static double sp(double fontSize) {
    if (kIsWeb) {
      // For web, use a simple scaling factor
      return fontSize * (screenWidth / _designWidth);
    }
    try {
      return fontSize.sp;
    } catch (e) {
      return fontSize; // Fallback to original value
    }
  }
  ...
  static double r(double radius) {
    ...
    try {
      ...
      return radius; // Fallback to original value
    }
  }
